...
java -cp target/classes:lib/fresco-0.2-SNAPSHOT-jar-with-dependencies.jar org.custom.code.App -l INFO -p1:localhost:12345 -p2:localhost:12346 -p3:localhost:12347  -s bgw -Dbgw.threshold=1 -i $1
#java -cp target/classes:lib/fresco-0.2-SNAPSHOT-jar-with-dependencies.jar org.custom.code.App -l INFO -p1:localhost:12345 -p2:localhost:12346 -p3:localhost:12347  -s dummy -i $1
